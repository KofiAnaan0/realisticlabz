	...
	return (
		<>
			...
			<button
				...
				className="fixed bottom-6 right-6 flex justify-center items-center h-14 w-14 bg-[#FFD9C2]/70 backdrop-blur-sm rounded-full cursor-pointer shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all duration-200 z-50 group"
			>
				...
				{agentState === "disconnected" && !isOpen && (
					<span className="absolute inset-0 rounded-full bg-[#FFD9C2] animate-ping opacity-75" />
				)}
			</button>
